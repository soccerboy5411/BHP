    ...
    while True:
        ...
        if len(local_buffer):
            ...
            if len(remote_buffer):
                ...
                remote_buffre = response_handler(remote_buffer)
...
def main():
    ...
    if len(sys.agrv[1:]) != 5:
        print "Usage: ./bhp_proxy.py [localhost] [localport] [remotehost] [remoteport] [receive_first]"
        print "Example: ./bhp_proxy.py 127.0.0.1 9000 10.12.132.1 9000 True"
        sys.exit(0)
